/* Includes ---------------------------------------------------------------- */
#include <Vehicle_Presence_inferencing.h> // Aca se carga la inferencia, se puede modificar por otra libreria para detectar otra cosa
...
int ei_edge_impulse(camera_fb_t *fb)
{
    ...
    #endif
    int vehicle_count = 0; //inicializa variable de cant de autos
    ...
    for (uint32_t i = 0; i < result.bounding_boxes_count; i++) {
        ...
        vehicle_count++;  // every valid box = one vehicle
