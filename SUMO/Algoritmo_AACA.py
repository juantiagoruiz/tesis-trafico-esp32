...
def set_TFL(TFL,E2_EO1,E2_EO2,E2_EO3,E2_NS,E2_SN,lanes_EO,lanes_NS,tiempo_seteado):
    ...
    if tiempo_seteado == 0:
        ...
        if traci.trafficlight.getPhase(TFL) == 0:            
            traci.trafficlight.setPhaseDuration(TFL,(3.8+(total_vehicles_NS*2.1)/lanes_NS))
            #print(total_vehicles_NS)
            tiempo_seteado = 1
        
        if traci.trafficlight.getPhase(TFL) == 2:            
            traci.trafficlight.setPhaseDuration(TFL,(3.8+(total_vehicles_SN*2.1)/lanes_NS))
            #print(total_vehicles_SN)
            tiempo_seteado = 1
    
        if traci.trafficlight.getPhase(TFL) == 4:            
            traci.trafficlight.setPhaseDuration(TFL,(3.8+(total_vehicles_EO*2.1)/lanes_EO))
            #print(total_vehicles_EO)
            tiempo_seteado = 1
        return tiempo_seteado
    
def set_TFL2(TFL,E2_EO1,E2_EO2,E2_EO3,E2_NS1,E2_NS2,E2_SN1,E2_SN2,lanes_EO,lanes_NS,tiempo_seteado):
    total_vehicles_EO = 0
    total_vehicles_NS = 0
    total_vehicles_SN = 0
    if traci.trafficlight.getPhase(TFL) == 1 or traci.trafficlight.getPhase(TFL) == 3 or traci.trafficlight.getPhase(TFL) == 5:
    ...
    if tiempo_seteado == 0:
        ...
        if traci.lanearea.getLastIntervalVehicleNumber(E2_EO1) > 0 or traci.lanearea.getLastIntervalVehicleNumber(E2_EO2) > 0 or traci.lanearea.getLastIntervalVehicleNumber(E2_EO3) > 0:
            total_vehicles_EO = traci.lanearea.getLastIntervalVehicleNumber(E2_EO1)+traci.lanearea.getLastIntervalVehicleNumber(E2_EO2)+traci.lanearea.getLastIntervalVehicleNumber(E2_EO3)
            #print(total_vehicles)
        if traci.lanearea.getLastIntervalVehicleNumber(E2_NS1) > 0 or traci.lanearea.getLastIntervalVehicleNumber(E2_NS2) > 0: 
            total_vehicles_NS = traci.lanearea.getLastIntervalVehicleNumber(E2_NS1) + traci.lanearea.getLastIntervalVehicleNumber(E2_NS2)
            #print(total_vehicles)
        if traci.lanearea.getLastIntervalVehicleNumber(E2_SN1) > 0 or traci.lanearea.getLastIntervalVehicleNumber(E2_SN2) > 0:
            total_vehicles_SN = traci.lanearea.getLastIntervalVehicleNumber(E2_SN1) + traci.lanearea.getLastIntervalVehicleNumber(E2_SN2)
            #print(total_vehicles)
...
traci.trafficlight.setProgram("1738355191",1)
traci.trafficlight.setProgram("1951912875",1)
traci.trafficlight.setProgram("1056968889",1)
traci.trafficlight.setProgram("1056968883",1)
traci.trafficlight.setProgram("1686155185",1)
...
while traci.simulation.getMinExpectedNumber() > 0 and  traci.simulation.getTime() < 2000:
    ...
    tiempo_seteado_TFL2 = set_TFL("1951912875","e2_3","e2_4","e2_5","e2_13","e2_14",2,1,tiempo_seteado_TFL2)
    tiempo_seteado_TFL3 = set_TFL2("1056968889","e2_6","e2_7","e2_8","e2_9","e2_10","e2_11","e2_12",1.5,1.5,tiempo_seteado_TFL3)
    tiempo_seteado_TFL4 = set_TFL2("1056968883","e2_21","e2_22","e2_27","e2_23","e2_24","e2_25","e2_26",1.5,1,tiempo_seteado_TFL4)
    tiempo_seteado_TFL5 = set_TFL("1686155185","e2_19","e2_20","e2_28","e2_18","e2_17",1.5,1,tiempo_seteado_TFL5)
    step_count += 1
