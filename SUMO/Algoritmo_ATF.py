...
# Tiempo fijo configurado con onda verde
traci.trafficlight.setProgram("1738355191",2)
traci.trafficlight.setProgram("1951912875",2)
traci.trafficlight.setProgram("1056968889",2)
traci.trafficlight.setProgram("1056968883",2)
traci.trafficlight.setProgram("1686155185",2)
...
Queue_HistoryDF.to_csv('C:/sumo_tesis/Queue_HistoryDF2.csv')
...
# Se exportan los datos como archivo csv
vehicle_dataDF.to_csv('C:/sumo_tesis/vehicle_dataDF2.csv')
...
# Se exportan los datos como archivo csv
waiting_dataDF.to_csv('C:/sumo_tesis/waiting_dataDF2.csv')
...
# Se exportan los datos como archivo csv
emissions_dataDF.to_csv('C:/sumo_tesis/emissions_dataDF2.csv')
